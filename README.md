...
| CVH (CdnVideoHub) | `cvh` | `/cdn-iframe/<id>/<season>/<episode>?dubbing=<studio>` or a numeric `<id>` | HLS, DASH, MP4 144p–1080p | ✅ |
...
with CvhPlayer() as player:
    ...
    # the older shape, with the dub in the path, still works
